...
let addNewContactButton = `<button class="new-contact" onclick="renderAddNewContact()">
<p>New contact</p> 
...
function RenderContactWithLetterSeparatorHTML(element, firstLetter, firstTwoLetters, i) {
...
function RenderContactWithoutLetterSeparatorHTML(element, firstTwoLetters, i) {
    return `
    <div class="frame_112"> 
    </div>
    <div class="contact_name" id="contact_${[i]}" onclick="showContactDetails(${[i]})"> 
...
function RenderContactDetailsHTML(x, element, firstTwoLetters) {
    return `  
    <div class="frame-105">
        <div class="frame_99">
...
function renderEditContactHTML(x, firstTwoLetters) {
    return `<div class="new-contact-main new-contact-main-animate" onclick="doNotClose(event)" id="new_contact_main">
    <div class="frame-194">
        <div class="capa2">${capa2}</div>
        <div class="frame-210">
